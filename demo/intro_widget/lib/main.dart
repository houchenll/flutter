...
void main() {
  runApp(MaterialApp(
    title: 'Shopping App', // used by the OS task switcher
    home: ShoppingList(
      products: <Product>[
        Product(name: 'Eggs'),
        Product(name: 'Flour'),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(5.0), color: Colors.green[500]),
        child: Center(
          child: Text('Engage'),
        ),
      ),
...
class _ShoppingListState extends State<ShoppingList> {
  ...
  void _onCardChangedCallback(Product product, bool inCart) {
    setState(() {
      if (!inCart) {
      ...
      body: ListView(
        ...
        children: widget.products.map((Product product) {
          return ShoppingListItem(
            ...
            onCartChanged: _onCardChangedCallback,
          );
        }).toList(),
      ),
    );
